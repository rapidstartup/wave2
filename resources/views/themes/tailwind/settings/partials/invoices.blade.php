<div class="p-8">
	...
	@subscriber
        ...
        @else
            <p class="text">Sorry, there seems to be an issue retrieving your invoices or you may not have any invoices yet.</p>
        @endif

	@notsubscriber
		<p class="text text-gray-600">When you subscribe to a plan, this is where you will be able to download your invoices.</p>
