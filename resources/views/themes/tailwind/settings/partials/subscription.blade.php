    ...
    @else
        @if(auth()->user()->subscriber())
            <div class="flex flex-col">
                <h5 class="mb-2 text-xl font-bold text-gray-700 dark:text-white">Modify Payment Information</h5>
            ...
            <hr class="my-8 border-gray-200 dark:border-white">

            <div class="flex flex-col">
                <h5 class="mb-2 text-xl font-bold text-gray-700 dark:text-white">Danger Zone</h5>
        ...
        @else
            <p class="text-gray-600 dark:text-white">Please <a href="{{ route('wave.settings', 'plans') }}">Subscribe to a Plan</a> in order to see your subscription information.</p>
